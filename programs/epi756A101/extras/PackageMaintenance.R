...
OhdsiRTools::checkUsagePackage("epi756A101")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/epi756A101.pdf")
shell("R CMD Rd2pdf ./ --output=extras/epi756A101.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("epi756A101")
