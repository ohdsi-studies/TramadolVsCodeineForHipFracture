...
for(i in 1:nrow(databases)){
        ...
        execute(connectionDetails = connectionDetails,
                ...
                runAnalyses = FALSE,
                runDiagnostics = FALSE,
                packageResults = TRUE, #need this to fix calibrated results
                maxCores = maxCores)
...
#-------------------------------------------------------------------------------
ps <- readRDS("S:/GIT/BitBucket/epi_756/programs/epi756A301/results/CDM_CPRD_V1102/cmOutput/Ps_l1_s1_p1_t16023_c15906.rds")
fileName <-  file.path(studyFolder, paste0("CDM_CPRD_V1102/PrefrenceScoreDistribution_A301.png"))
...
balance <- readRDS("S:/GIT/BitBucket/epi_756/programs/epi756A301/results/CDM_CPRD_V1102/balance/bal_t16023_c15906_o15066_a1.rds")
fileName <-  file.path(studyFolder, paste0("CDM_CPRD_V1102/CovariateBalanceBeforeAndAfterPS_A301.png"))
