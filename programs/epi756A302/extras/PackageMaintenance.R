...
OhdsiRTools::checkUsagePackage("epi756A302")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/epi756A302.pdf")
shell("R CMD Rd2pdf ./ --output=extras/epi756A302.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("epi756A302")
