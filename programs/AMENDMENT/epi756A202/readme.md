...
2. In `R`, use the following `devtools` command to install the epi756A202 package:
...
License
=======
The epi756A202 package is licensed under Apache License 2.0

Development
===========
epi756A202 was developed in ATLAS and R Studio.
