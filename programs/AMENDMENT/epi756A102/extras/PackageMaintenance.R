...
OhdsiRTools::checkUsagePackage("epi756A102")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/epi756A102.pdf")
shell("R CMD Rd2pdf ./ --output=extras/epi756A102.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("epi756A102")
