...
studyFolder <- "S:/GIT/BitBucket/epi_756/programs/AMENDMENT/epi756A201/results"
study <- "A201"
...
#-------------------------------------------------------------------------------
ps <- readRDS(file.path(studyFolder, paste0("CDM_CPRD_V1102/cmOutput/Ps_l1_s1_p1_t16022_c16020.rds")))
...
balance <- readRDS(file.path(studyFolder, paste0("CDM_CPRD_V1102/balance/bal_t16022_c16020_o15066_a1.rds")))
