...
2. In `R`, use the following `devtools` command to install the epi756A201 package:
...
License
=======
The epi756A201 package is licensed under Apache License 2.0

Development
===========
epi756A201 was developed in ATLAS and R Studio.
