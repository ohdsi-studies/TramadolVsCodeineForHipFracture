...
#' @export
doMetaAnalysis <- function(packageName,
                           studyFolder,
                           outputFolders,
                           maOutputFolder,
                           maxCores) {
  ...
  #   (allResults$databaseId %in% c("CCAE", "MDCD", "MDCR", "OptumEHR", "OpenClaims", "AmbEMR") & allResults$outcomeId %in% c(18, 19)) | # death, cv death
