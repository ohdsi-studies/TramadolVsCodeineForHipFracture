...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1133201,1133732,1201620,19021940,19088393,1189596,1154029,1174888,1126658,1102527,19003010,1103640,1110410,19112635,1114122,1124957,1125765,19129648,1130585,19132884,19134009,1153664,19026459,19002431,1103314)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1133201,1133732,1201620,19021940,19088393,1189596,1154029,1174888,1126658,1102527,19003010,1103640,1110410,19112635,1114122,1124957,1125765,19129648,1130585,19132884,19134009,1153664,19026459,19002431,1103314)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4335394,4099935,438130,37016268,4084011,433083)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4335394,4099935,438130,37016268,4084011,433083)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (46273539,4006969,254761,4170143,4283893,252662)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (46273539,4006969,254761,4170143,4283893,252662)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (21603365)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (21603365)
  and c.invalid_reason is null
...
WHERE C.drug_exposure_start_date > DATEFROMPARTS(1994, 12, 31)
AND (YEAR(C.drug_exposure_start_date) - P.year_of_birth >= 50 and YEAR(C.drug_exposure_start_date) - P.year_of_birth <= 89)
...
(
  SELECT co.* 
  FROM @cdm_database_schema.CONDITION_OCCURRENCE co
  JOIN #Codesets codesets on ((co.condition_source_concept_id = codesets.concept_id and codesets.codeset_id = 13))
) C
