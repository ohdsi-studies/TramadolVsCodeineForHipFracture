...
2. In `R`, use the following `devtools` command to install the epi756A101 package:
...
License
=======
The epi756A101 package is licensed under Apache License 2.0

Development
===========
epi756A101 was developed in ATLAS and R Studio.
