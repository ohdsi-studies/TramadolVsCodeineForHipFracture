...
OhdsiRTools::checkUsagePackage("epi756A301")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/epi756A301.pdf")
shell("R CMD Rd2pdf ./ --output=extras/epi756A301.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("epi756A301")
