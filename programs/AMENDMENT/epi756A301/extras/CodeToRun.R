...
studyFolder <- "S:/GIT/BitBucket/epi_756/programs/epi756A301/results"
#studyFolder <- "S:/BitBucket/epi_756/programs/epi756A301/results"
...
for(i in 1:2){
        ...
        negativesAll <- read.csv("S:/BitBucket/epi_756/programs/epi756A301/results/CDM_CPRD_V1102/export/cohort_method_result.csv")
...
StratPop <- readRDS("S:/GIT/BitBucket/epi_756/programs/epi756A301/results/CDM_CPRD_V1102/cmOutput/StratPop_l1_s1_p1_t16023_c15906_s1_o15066.rds")
StratPop <- StratPop[,c(2,3)]
conn <- DatabaseConnector::connect(connectionDetails = connectionDetails)
DatabaseConnector::dbWriteTable(conn,value = StratPop,name=paste0('SCRATCH.dbo.EPI756_cohort_diagnostics_cprd_A301_StratPop'),
...
#-------------------------------------------------------------------------------
#fixed removeSubjectsWithPriorOutcome = true

studyFolder <- "S:/GIT/BitBucket/epi_756/programs/AMENDMENT/epi756A301/results"
study <- "A301"
...
#-------------------------------------------------------------------------------
ps <- readRDS(file.path(studyFolder, paste0("CDM_CPRD_V1102/cmOutput/Ps_l1_s1_p1_t16023_c15906.rds")))
fileName <-  file.path(studyFolder, paste0("CDM_CPRD_V1102/PrefrenceScoreDistribution_",study,".png"))
CohortMethod::plotPs(data = ps,
                     targetLabel = "T2 - Tramadol",
                     comparatorLabel = "C2 - Codeine",
...
balance <- readRDS(file.path(studyFolder, paste0("CDM_CPRD_V1102/balance/bal_t16023_c15906_o15066_a1.rds")))
fileName <-  file.path(studyFolder, paste0("CDM_CPRD_V1102/CovariateBalanceBeforeAndAfterPS_",study,".png"))
