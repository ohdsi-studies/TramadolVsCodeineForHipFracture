...
OhdsiRTools::checkUsagePackage("epi756A202")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/epi756A202.pdf")
shell("R CMD Rd2pdf ./ --output=extras/epi756A202.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("epi756A202")
