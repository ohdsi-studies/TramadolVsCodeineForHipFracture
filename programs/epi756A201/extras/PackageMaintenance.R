...
OhdsiRTools::checkUsagePackage("epi756A201")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/epi756A201.pdf")
shell("R CMD Rd2pdf ./ --output=extras/epi756A201.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("epi756A201")
