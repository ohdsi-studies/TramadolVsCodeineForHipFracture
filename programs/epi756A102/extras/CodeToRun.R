...
studyFolder <- "S:/GIT/BitBucket/epi_756/programs/epi756A102/results"
#studyFolder <- "s:/BitBucket/epi_756/programs/epi756A102/results"
...
file.copy(from = c(list.files(file.path(studyFolder, "CDM_IBM_CCAE_V1103", "shinyData"), full.names = TRUE),
                   list.files(file.path(studyFolder, "CDM_IBM_MDCR_V1104", "shinyData"), full.names = TRUE),
                   list.files(file.path(studyFolder, "CDM_IBM_MDCD_V1105", "shinyData"), full.names = TRUE),
                   list.files(file.path(studyFolder, "CDM_OPUM_EXTENDED_DOD_V1107", "shinyData"), full.names = TRUE),
                   list.files(file.path(studyFolder, "CPRD", "shinyData"), full.names = TRUE),
                   list.files(file.path(studyFolder, "CDM_JMDC_V1106", "shinyData"), full.names = TRUE),
